...
export class Topology {
  ...
  open(data?: any) {
    ...
    this.data.filetype = data.filetype;
  ...
  private onMouseMove = (e: MouseEvent) => {
    ...
    requestAnimationFrame(() => {
      ...
      const moveOutX =
        pos.x + 100  > this.canvas.width;
      // console.log(pos.x,this.canvas.width);
  ...
  toImage(
    ...
    if(image_y && image_ey){
      canvas.height = image_ey - image_y;
      canvas.style.height = (image_ey - image_y) + 'px';
    }else {
  ...
  saveAsImage(
    ...
    a.setAttribute('download', name || '德荣工业.png');
